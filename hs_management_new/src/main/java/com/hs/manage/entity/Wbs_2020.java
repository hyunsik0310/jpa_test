...
public class Wbs_2020 {
		...
		public String toString() {
			return "Wbs_2020 [date=" + date + ", u_no=" + u_no + ", start_time=" + start_time + ", end_time=" + end_time
					+ ", rest_time=" + rest_time + ", vacation_type=" + vacation_type + ", memo=" + memo + ", reg_date="
					+ reg_date + ", upd_date=" + upd_date + "]";
		}
